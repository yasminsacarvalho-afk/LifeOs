...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Dashboard Financeiro · LifeOs" },
      {
        name: "description",
        content:
      ...
      <TopBar
        ...
        actions={
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/monitor"
              className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-primary to-accent px-4 py-2 text-sm font-medium text-primary-foreground shadow-glow-accent hover:scale-[1.01] transition-transform"
            >
