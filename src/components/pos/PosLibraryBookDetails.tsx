            ...
            <>
              ...
              <div className="absolute right-0 top-12 w-56 bg-[#1A1A1E] border border-[rgba(255,255,255,0.1)] rounded-xl shadow-2xl z-40 overflow-hidden animate-in fade-in zoom-in-95">
                <div className="py-1">
                  ...
                  <button onClick={() => { setShowMenu(false); document.getElementById('edit-book-btn')?.click(); }} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-white hover:bg-white/5"><Edit2 size={16}/> Editar livro</button>
